...
public:
	...
	/**
	 * This generates message ready to be sent over p2p tunnel. This version can be used when we are relaying a message or sending a message by ourselves.
	 ...
	 */
	protocol::p2pMessage generateMessage(peer::TH src_th, peer::TH dest_th, protocol::p2pMessage_Payload payload);
	/**
	 * This generates message ready to be sent over p2p tunnel. This version can be used when we are sending a message by ourselves to a specific peer.
	 * @param dest_th -- destination TH
	 * @param payload -- payload, generated by MessageGenerator::generate*.
	 * @return
	 */
	protocol::p2pMessage generateMessage(peer::TH dest_th, protocol::p2pMessage_Payload payload);
